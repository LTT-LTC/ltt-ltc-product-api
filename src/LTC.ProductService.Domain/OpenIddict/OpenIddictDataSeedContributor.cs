...
namespace LTC.ProductService.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ProductService") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ProductService", DisplayName = "ProductService API", Resources = { "ProductService" }
            });
        }
    }
