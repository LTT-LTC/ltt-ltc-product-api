...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 058ee38a-0cc3-42e6-ac41-8bdc20086de2
```

> `058ee38a-0cc3-42e6-ac41-8bdc20086de2` is the password of the certificate, you can change it to any password you want.
